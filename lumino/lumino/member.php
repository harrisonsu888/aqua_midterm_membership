		...
		<!-- <form name="myForm" method="POST" action=""> --> 
			<table class="table sortable" id="myTable">
				...
				<tr>
					...
					<td>
                    	<a href="./edit.php?editId=<?php echo $arr[$i]['memberId'] ?>"><img name="search" class="functionsize" src="icon/search.png" alt=""></a>
                    	<a href="./delete.php?deletememberId=<?php echo $arr[$i]['memberId']; ?>"><img name="recycle"class="functionsize" src="icon/recycle.png" alt=""></a>
					</td>
				</tr>
				<?php
						}
